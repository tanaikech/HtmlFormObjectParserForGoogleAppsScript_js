/**
 * GitHub  https://github.com/tanaikech/HtmlFormObjectParserForGoogleAppsScript_js
_js<br>
 ...
 */
function ParseFormObjectForGAS(formObj, fields, excludeTypes) {
...
(function (r) {
  ...
  HtmlFormObjectParserForGoogleAppsScript = function () {
    class HtmlFormObjectParserForGoogleAppsScript {
      constructor(obj_, fieldsValue_, excludeTypes_) {
      ...
      async Do() {
        ...
        try {
          ar = await Promise.all(
            this.formObj.map((obj) => {
              return new Promise(async (res, rej) => {
                var files, htmlObj, i, temp;
                htmlObj = {};
                for (i in obj) {
  ...
  return (r.HtmlFormObjectParserForGoogleAppsScript = HtmlFormObjectParserForGoogleAppsScript);
})(this);
